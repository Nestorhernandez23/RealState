...
public class Reo {
    ...
    private static void createRandomBid(Listings listings) {
        ...
        String[] autoBidders = {"Patrick Stewart", "Walter Hoenir", "William Shatter", "Leonard Nimby", "DeForest Kelley", "James Dothan", "George Taken", "Mabel Barrett", "Michelle Nichole", "Jonathan Frank", "Marina Sirtis", "Brent Spiner", "Gates McFadden", "Michael Dorn", "LeVar Burton", "Wil Wheaton", "Colm Meaney", "Michelle Forbes"};
